...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        course_header_frame.grid_columnconfigure(1, minsize=35)  # Credits - very compact for 360px window
        course_header_frame.grid_columnconfigure(2, minsize=40)  # Grade - very compact for 360px window
        course_header_frame.grid_columnconfigure(3, minsize=25)  # Remove - very compact trash can icon
    ...
    def _add_subject_row(self, name, credit, grade):
        # Create row with simple pack layout (optimized for 360px window)
        row_container = ctk.CTkFrame(self.subject_list_frame, height=40, corner_radius=6)
        row_container.pack(fill="x", pady=1, padx=3)
        row_container.pack_propagate(False)
        
        # Course name (flexible - takes most space)
        ...
        name_entry.pack(side="left", fill="x", expand=True, padx=(8, 4), pady=8)

        # Credit hours (very compact for 360px window)
        ...
        credit_entry.pack(side="left", padx=(0, 4), pady=8)

        # Grade (very compact for 360px window)
        ...
        grade_option.pack(side="left", padx=(0, 4), pady=8)
        
        # Remove button - trash can icon (very compact)
