...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        course_header_frame.grid_columnconfigure(1, minsize=50)  # Credits - just wide enough for "3.0"
        course_header_frame.grid_columnconfigure(2, minsize=50)  # Grade - just wide enough for "A+"
        course_header_frame.grid_columnconfigure(3, minsize=70)  # Remove - compact button
        
        # Header labels
        ctk.CTkLabel(course_header_frame, text="Course Name", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=0, sticky="w", padx=(12, 4), pady=8)
        ...
        ctk.CTkLabel(course_header_frame, text="Remove", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=3, sticky="w", padx=(0, 12), pady=8)
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row_container.grid_columnconfigure(1, minsize=70) # Credits - wider for better usability
        row_container.grid_columnconfigure(2, minsize=60) # Grade - wider for better usability
        ...
        # Credit hours (compact - just wide enough for "3.0")
        ...
        # Grade (compact - just wide enough for "A+")
