...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        ctk.CTkLabel(name_row, text="Subject Name:", font=ctk.CTkFont(size=14), text_color="#4b5563").pack(side="left")
        ...
        ctk.CTkLabel(credit_row, text="Credit Hours:", font=ctk.CTkFont(size=14), text_color="#4b5563").pack(side="left")
        ...
        ctk.CTkLabel(grade_row, text="Grade:", font=ctk.CTkFont(size=14), text_color="#4b5563").pack(side="left")
