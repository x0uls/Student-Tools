...
class GPACalculatorPage(ctk.CTkFrame):
    ...
    def _create_semester_card(self, sem):
        # Modern card design
        card = ctk.CTkFrame(self.semester_frame, corner_radius=15, height=80)
        ...
        # GPA display with better styling
        gpa_frame = ctk.CTkFrame(left_frame, fg_color="#374151", corner_radius=8)
