...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        # Subject name entry
        name_entry = ctk.CTkEntry(content_frame, width=150, height=25, corner_radius=6)
        name_entry.insert(0, str(name) if name is not None else "")
        name_entry.pack(side="left", padx=(0, 8))

        # Credit hours entry
        credit_entry = ctk.CTkEntry(content_frame, width=50, height=25, corner_radius=6)
        credit_entry.insert(0, str(credit) if credit is not None else "")
        credit_entry.pack(side="left", padx=(0, 8))
        ...
        grade_option.pack(side="left", padx=(0, 8))
