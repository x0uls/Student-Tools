...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        # Create row with fixed layout for precise control
        ...
        # Course name (flexible width - takes remaining space)
        ...
        name_entry.place(x=12, y=8, relwidth=0.65, height=25)  # Takes 65% of width

        # Credit hours (fixed compact width)
        ...
        credit_entry.place(x=12, y=8, relx=0.68, height=25)  # Positioned at 68% from left

        # Grade (fixed compact width)
        ...
        grade_option.place(x=12, y=8, relx=0.78, height=25)  # Positioned at 78% from left
        ...
        del_btn.place(x=12, y=8, relx=0.88, height=25)  # Positioned at 88% from left
