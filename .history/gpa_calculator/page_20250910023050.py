...
class GPACalculatorPage(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        # Top section with title and CGPA
        ...
        # CGPA display - large and prominent
        cgpa_display = ctk.CTkFrame(top_section, fg_color="#1e40af", corner_radius=15)
        cgpa_display.pack(fill="x", pady=(0, 10))
        
        cgpa_title = ctk.CTkLabel(
            cgpa_display,
            text="Cumulative GPA",
            font=ctk.CTkFont(size=14),
            text_color="#93c5fd"
        )
        cgpa_title.pack(pady=(10, 0))
        ...
        self.cgpa_label.pack(pady=(0, 15))
        ...
        # Semesters section
        semesters_label = ctk.CTkLabel(
            self,
            text="📚 Semesters",
            font=ctk.CTkFont(size=16, weight="bold"),
            text_color="#ffffff"
        )
        semesters_label.pack(pady=(10, 5), padx=20, anchor="w")
    ...
    def _create_semester_card(self, sem):
        ...
        name_container = ctk.CTkFrame(info_frame, fg_color="#1e40af", corner_radius=6)
        ...
        # GPA display - subtle styling with container
        gpa_container = ctk.CTkFrame(info_frame, fg_color="#374151", corner_radius=6)
        gpa_container.pack(fill="x")
        ...
        gpa_label.pack(fill="x", padx=8, pady=3)
