...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        form_frame = ctk.CTkFrame(self, fg_color="#f8f9fa", corner_radius=12)
        ...
        ctk.CTkLabel(name_row, text="Subject Name:", font=ctk.CTkFont(size=14), text_color="#2c3e50").pack(side="left")
        ...
        ctk.CTkLabel(credit_row, text="Credit Hours:", font=ctk.CTkFont(size=14), text_color="#2c3e50").pack(side="left")
        ...
        ctk.CTkLabel(grade_row, text="Grade:", font=ctk.CTkFont(size=14), text_color="#2c3e50").pack(side="left")
