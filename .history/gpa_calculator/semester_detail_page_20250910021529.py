...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        gpa_container = ctk.CTkFrame(header_content, fg_color="#f8f9fa", corner_radius=10)
        ...
        ctk.CTkLabel(name_row, text="Subject Name:", font=ctk.CTkFont(size=14)).pack(side="left")
        self.subject_entry = ctk.CTkEntry(name_row, width=200, height=35)
        ...
        ctk.CTkLabel(credit_row, text="Credit Hours:", font=ctk.CTkFont(size=14)).pack(side="left")
        self.credit_entry = ctk.CTkEntry(credit_row, width=200, height=35)
        ...
        ctk.CTkLabel(grade_row, text="Grade:", font=ctk.CTkFont(size=14)).pack(side="left")
        ...
        self.subject_list_frame = ctk.CTkScrollableFrame(
            self, 
            label_text="Subjects Added",
            corner_radius=15
        )
        self.subject_list_frame.pack(fill="both", expand=True, padx=20, pady=(0, 15))
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row.pack_propagate(False)  # Maintain fixed height
        ...
        # Subject name entry
        name_entry = ctk.CTkEntry(content_frame, width=200, height=35)
        name_entry.insert(0, name)
        name_entry.pack(side="left", padx=(0, 10))

        # Credit hours entry
        credit_entry = ctk.CTkEntry(content_frame, width=80, height=35)
