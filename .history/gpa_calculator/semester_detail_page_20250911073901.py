...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        name_entry.pack(side="left", fill="x", expand=True, padx=(12, 8), pady=8)

        # Credit hours (compact - fixed width)
        ...
        credit_entry.pack(side="left", padx=(0, 8), pady=8)

        # Grade (compact - fixed width)
        ...
        grade_option.pack(side="left", padx=(0, 8), pady=8)
        ...
        del_btn.pack(side="right", padx=(0, 12), pady=8)
