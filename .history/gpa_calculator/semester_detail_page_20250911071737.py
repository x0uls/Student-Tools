...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row_container.grid_columnconfigure(1, minsize=50) # Credits - just wide enough for "3.0"
        row_container.grid_columnconfigure(2, minsize=50) # Grade - just wide enough for "A+"
        row_container.grid_columnconfigure(3, minsize=70) # Remove - compact button
