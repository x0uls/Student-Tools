...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        name_entry = ctk.CTkEntry(row_container, height=30, corner_radius=6, font=ctk.CTkFont(size=12))
        name_entry.insert(0, str(name) if name is not None else "")
        name_entry.pack(side="left", fill="x", expand=True, padx=(10, 5), pady=10)
