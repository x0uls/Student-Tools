...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        self.subject_entry = ctk.CTkEntry(form_frame, height=30, width=200, corner_radius=6)
        ...
        # Course list header
        header_frame = ctk.CTkFrame(self, fg_color="#1a2b4c", corner_radius=8)
        header_frame.pack(fill="x", padx=15, pady=(10, 5))
        header_frame.grid_columnconfigure(0, weight=1)  # Course name - flexible
        header_frame.grid_columnconfigure(1, minsize=80)  # Credits - fixed
        header_frame.grid_columnconfigure(2, minsize=70)  # Grade - fixed  
        header_frame.grid_columnconfigure(3, minsize=80)  # Remove - fixed
        
        # Header labels
        ctk.CTkLabel(header_frame, text="Course Name", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=0, sticky="w", padx=(12, 4), pady=8)
        ctk.CTkLabel(header_frame, text="Credits", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=1, sticky="w", padx=(0, 4), pady=8)
        ctk.CTkLabel(header_frame, text="Grade", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=2, sticky="w", padx=(0, 4), pady=8)
        ctk.CTkLabel(header_frame, text="Remove", font=ctk.CTkFont(size=12, weight="bold"), text_color="#ffffff").grid(row=0, column=3, sticky="w", padx=(0, 12), pady=8)
