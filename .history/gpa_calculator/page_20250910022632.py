...
class GPACalculatorPage(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        title_container = ctk.CTkFrame(header_frame, fg_color="#1e3a8a", corner_radius=10)
        ...
        cgpa_container = ctk.CTkFrame(header_frame, fg_color="#374151", corner_radius=12)
        ...
        # Chart link - subtle and clean with container
        chart_container = ctk.CTkFrame(bottom_frame, fg_color="#4b5563", corner_radius=8)
        ...
        self.chart_link.pack(pady=8, padx=12)
