...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        ctk.CTkLabel(header_frame, text="Course Name", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="left", padx=(10, 0))
        ctk.CTkLabel(header_frame, text="Credits", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="left", padx=(20, 0))
        ctk.CTkLabel(header_frame, text="Grade", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="left", padx=(15, 0))
        ctk.CTkLabel(header_frame, text="Action", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="right", padx=(0, 10))
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row_container = ctk.CTkFrame(self.subject_list_frame, fg_color="transparent")
        row_container.pack(fill="x", pady=2)
        
        # Create the actual row frame
        row = ctk.CTkFrame(row_container, height=40, corner_radius=8)
        row.pack(fill="x", padx=5)
        row.pack_propagate(False)
        
        # Create a content frame inside the row
        content = ctk.CTkFrame(row, fg_color="transparent")
        content.pack(fill="both", expand=True, padx=10, pady=8)
        
        # Course name - takes most space
        name_entry = ctk.CTkEntry(content, height=25, corner_radius=6, font=ctk.CTkFont(size=12))
        name_entry.insert(0, str(name) if name is not None else "")
        name_entry.pack(side="left", fill="x", expand=True, padx=(0, 10))
        
        # Credits - fixed width
        credit_entry = ctk.CTkEntry(content, width=50, height=25, corner_radius=6, font=ctk.CTkFont(size=12))
        ...
        # Delete button - made bigger and more visible
