...
class GPACalculatorPage(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        chart_container = ctk.CTkFrame(bottom_frame, fg_color="#fef7ed", corner_radius=8)
    ...
    def _create_semester_card(self, sem):
        ...
        name_container = ctk.CTkFrame(info_frame, fg_color="#fef3c7", corner_radius=6)
        ...
        gpa_container = ctk.CTkFrame(info_frame, fg_color="#fef7ed", corner_radius=6)
