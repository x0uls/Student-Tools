...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        # GPA display - prominent
        gpa_display = ctk.CTkFrame(header_frame, fg_color="#1e40af", corner_radius=12)
        gpa_display.pack(fill="x")
