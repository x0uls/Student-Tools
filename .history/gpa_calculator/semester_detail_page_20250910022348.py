...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        # Semester name - clean typography with container
        title_container = ctk.CTkFrame(header_content, fg_color="#fef3c7", corner_radius=8)
        ...
        title_label.pack(pady=10, padx=16)
        
        # GPA display - subtle container
        gpa_container = ctk.CTkFrame(header_content, fg_color="#fef3c7", corner_radius=10)
        ...
        form_frame = ctk.CTkFrame(self, fg_color="#fef7ed", corner_radius=12)
        ...
        name_label_container = ctk.CTkFrame(name_row, fg_color="#fef3c7", corner_radius=6)
        name_label_container.pack(side="left")
        ctk.CTkLabel(name_label_container, text="Subject Name:", font=ctk.CTkFont(size=14), text_color="#92400e").pack(pady=6, padx=10)
        ...
        credit_label_container = ctk.CTkFrame(credit_row, fg_color="#fef3c7", corner_radius=6)
        credit_label_container.pack(side="left")
        ctk.CTkLabel(credit_label_container, text="Credit Hours:", font=ctk.CTkFont(size=14), text_color="#92400e").pack(pady=6, padx=10)
        ...
        grade_label_container = ctk.CTkFrame(grade_row, fg_color="#fef3c7", corner_radius=6)
        grade_label_container.pack(side="left")
        ctk.CTkLabel(grade_label_container, text="Grade:", font=ctk.CTkFont(size=14), text_color="#92400e").pack(pady=6, padx=10)
