...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        course_header_frame.grid_columnconfigure(1, minsize=80)  # Credits - fixed
        course_header_frame.grid_columnconfigure(2, minsize=70)  # Grade - fixed  
        course_header_frame.grid_columnconfigure(3, minsize=80)  # Remove - fixed
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        # Configure grid columns to match header layout
        row_container.grid_columnconfigure(0, weight=1)  # Course name - flexible
        row_container.grid_columnconfigure(1, minsize=80)  # Credits - fixed
        row_container.grid_columnconfigure(2, minsize=70)  # Grade - fixed  
        row_container.grid_columnconfigure(3, minsize=80)  # Remove - fixed
        
        # Course name - flexible width
        name_entry = ctk.CTkEntry(row_container, height=25, corner_radius=6, font=ctk.CTkFont(size=11))
        name_entry.insert(0, str(name) if name is not None else "")
        name_entry.grid(row=0, column=0, sticky="ew", padx=(12, 4), pady=8)
        
        # Credits - fixed width
        credit_entry = ctk.CTkEntry(row_container, height=25, corner_radius=6, font=ctk.CTkFont(size=11))
        credit_entry.insert(0, str(credit) if credit is not None else "")
        credit_entry.grid(row=0, column=1, sticky="ew", padx=(0, 4), pady=8)
        ...
        grade_option.grid(row=0, column=2, sticky="ew", padx=(0, 4), pady=8)
        ...
        del_btn.grid(row=0, column=3, sticky="ew", padx=(0, 12), pady=8)
