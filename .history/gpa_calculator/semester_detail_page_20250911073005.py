...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        course_header_frame.grid_columnconfigure(1, minsize=90)  # Credits - bigger for better usability
        course_header_frame.grid_columnconfigure(2, minsize=80)  # Grade - bigger for better usability
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row_container.grid_columnconfigure(1, minsize=90) # Credits - bigger for better usability
        row_container.grid_columnconfigure(2, minsize=80) # Grade - bigger for better usability
        ...
        # Credit hours (bigger for better usability)
        ...
        # Grade (bigger for better usability)
