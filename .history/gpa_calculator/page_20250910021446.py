...
class GPACalculatorPage(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        # Main title - minimalist typography
        ...
        cgpa_container = ctk.CTkFrame(header_frame, fg_color="#f8f9fa", corner_radius=12)
        ...
        self.scrollable_frame = ctk.CTkScrollableFrame(self, label_text="Semesters")
        ...
        bottom_frame.pack(fill="x", pady=(10, 20), padx=20)
        ...
        self.add_sem_btn.pack(pady=(0, 10))
    ...
    def _create_semester_card(self, sem):
        ...
        card.pack_propagate(False)  # Maintain fixed height
        sem["card"] = card
