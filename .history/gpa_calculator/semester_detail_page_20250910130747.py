...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        # Subjects list header - using grid for perfect alignment
        header_frame = ctk.CTkFrame(self, fg_color="transparent")
        header_frame.pack(fill="x", padx=20, pady=(10, 5))
        header_frame.grid_columnconfigure(0, weight=1)
        header_frame.grid_columnconfigure(1, minsize=50)
        header_frame.grid_columnconfigure(2, minsize=70)
        header_frame.grid_columnconfigure(3, minsize=25)
        
        # Header labels
        ctk.CTkLabel(header_frame, text="Course Name", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").grid(row=0, column=0, sticky="w", padx=(10, 8))
        ctk.CTkLabel(header_frame, text="Credits", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").grid(row=0, column=1, sticky="w", padx=(0, 8))
        ctk.CTkLabel(header_frame, text="Grade", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").grid(row=0, column=2, sticky="w", padx=(0, 8))
        ctk.CTkLabel(header_frame, text="Action", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").grid(row=0, column=3, sticky="e", padx=(0, 10))
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        row.grid_columnconfigure(2, minsize=70)
        row.grid_columnconfigure(3, minsize=25)
        ...
        # Credit hours entry
        credit_entry = ctk.CTkEntry(row, width=50, height=25, corner_radius=6)
