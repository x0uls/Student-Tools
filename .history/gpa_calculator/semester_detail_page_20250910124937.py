...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        # Header labels
        ctk.CTkLabel(header_frame, text="Course Name", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="left", padx=(0, 8))
        ...
        ctk.CTkLabel(header_frame, text="Action", font=ctk.CTkFont(size=12, weight="bold"), text_color="#d1d5db").pack(side="right")
