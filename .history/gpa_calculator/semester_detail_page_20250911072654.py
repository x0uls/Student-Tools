...
class SemesterDetailPage(ctk.CTkFrame):
    def __init__(
        ...
        course_header_frame.grid_columnconfigure(1, minsize=70)  # Credits - wider for better usability
        course_header_frame.grid_columnconfigure(2, minsize=60)  # Grade - wider for better usability
