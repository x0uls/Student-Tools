...
class SemesterDetailPage(ctk.CTkFrame):
    ...
    def _add_subject_row(self, name, credit, grade):
        ...
        # Configure grid columns - total width should fit in 360px
        row_container.grid_columnconfigure(0, weight=1)  # Course name - flexible
        row_container.grid_columnconfigure(1, minsize=50)  # Credits - fixed
        row_container.grid_columnconfigure(2, minsize=60)  # Grade - fixed  
        row_container.grid_columnconfigure(3, minsize=80)  # Delete - fixed
        ...
        name_entry.grid(row=0, column=0, sticky="ew", padx=(8, 4), pady=8)
        ...
        # Delete button - GUARANTEED to be visible
        ...
        del_btn.grid(row=0, column=3, sticky="e", padx=(0, 8), pady=8)
